...
const Footer = () => {
 ...
 <footer className="site-footer">
      <div className="footer-container">
        ...
        <h1 className="footer-logo"><img src="./fish1.gif" alt="Aqua Shop Logo" className="footer-logo" style={{maxHeight:"150px"}} /></h1>
          <h1 className="footer-logo-text"><img src="./logo-removebg-preview.png" alt="Aqua Shop Logo" className="footer-logo" style={{maxHeight:"150px"}} /></h1>
